...
$config['licenseKey']  = 'TB3BKQ2SGBP3LHCFSPH88HYY7EWNJ';
...
$userDirectory  = isset($_SESSION['userDirectory '])? $_SESSION['userDirectory ']:'';
...
$ck_directory = isset($_SESSION['ck_directory'])? $_SESSION['ck_directory']:'';
...
$config['resourceTypes'][] = array(
    'name'              => 'Images',
	'url' 				=> $baseUrl . 'images',
    'directory'         => $baseDir . 'images'.$ck_directory,
    'maxSize'           => '20M',
    'allowedExtensions' => 'gif,jpeg,jpg,png',
    'deniedExtensions'  => 'php,php3,php5,phtml,asp,aspx,ascx,jsp,cfm,cfc,pl,bat,exe,dll,reg,cgi,htaccess,html,htm,xhtml,js',
    'backend'           => 'default'
);
...
$folder_create = isset($_SESSION['FOLDER_CREATE'])? $_SESSION['FOLDER_CREATE']: 0;
$folder_rename = isset($_SESSION['FOLDER_RENAME'])? $_SESSION['FOLDER_RENAME']: 0;
$folder_delete = isset($_SESSION['FOLDER_DELETE'])? $_SESSION['FOLDER_DELETE']: 0;
